...
class VideomuxPlugin extends JanusPlugin {
  VideomuxPlugin({handleId, context, transport, session}) : super(context: context, handleId: handleId, plugin: JanusPlugins.VIDEOMUX, session: session, transport: transport);
